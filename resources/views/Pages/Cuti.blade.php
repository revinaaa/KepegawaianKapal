                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('cuti.profile', $item->slug) }}" class="btn btn-info btn-sm">
                                                <i class="bi bi-eye-fill me-1">detail</i>
                                            </a>
                                            ...
                                            @if (Auth::user()->role_id == 1)
                                                ...
                                                <form action="{{ route('cuti.destroy', $item->slug) }}" method="POST"
                                                    class="d-inline"
                                                ...
                                                <form action="{{ route('cuti.update', $item->slug) }}" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="id_karyawan" class="form-label">Nama
                                                                        Karyawan</label>
                                                                    <select class="form-select" name="id_karyawan"
                                                                        id="id_karyawan" required>
                                                                        <option value="">-- Pilih Karyawan --</option>
                                                                        @foreach ($karyawans as $karyawan)
                                                                            <option value="{{ $karyawan->id }}"
                                                                                {{ $item->id_karyawan == $karyawan->id ? 'selected' : '' }}>
                                                                                {{ $karyawan->nama }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
